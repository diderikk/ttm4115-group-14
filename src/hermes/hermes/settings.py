...
SECRET_KEY = "django-insecure-!dy&5_jqkmksdhdf(7f6tbc+ko_t6769*v$0^ts8=$a$b!m4hw"
...
ROOT_URLCONF = "hermes.hermes.urls"
...
WSGI_APPLICATION = "hermes.hermes.wsgi.application"
...
DATABASES = {
    "default": {
        ...
        "USER": "postgres",
        "PASSWORD": "postgres",
        "HOST": "ec2-13-53-46-117.eu-north-1.compute.amazonaws.com",
        "PORT": "5432",
    },
}
